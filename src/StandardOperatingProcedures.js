...
/**
 * Footer Component for the Aligarh Muslim University website.
 * Displays copyright information and contact details.
 * It is styled using embedded CSS within a <style> tag.
 */
const Footer = () => {
  return (
    <>
...
/**
 * Layout Component wraps the Header, main content, and Footer.
 * It provides the basic structure for the application.
 */
...
/**
 * Standard Operating Procedures Component.
 * This component displays the full SOPs text in a well-structured, readable format.
 * It uses embedded CSS to style the document content.
 */
